...
function [Sparse_Data,graph_indexed, concept_a, concept_b, a_freq, b_freq, ab_freq, p_value, fdr]=Get_Indexed_data_fdr(graph,Concept2Dict)
...
graph_indexed=array2table(graph_indexed,'VariableNames',{'ConceptA','ConceptB','AFreq','BFreq','ABFreq','Pvalue','fdr'});

Sparse_Data = sparse([concept_a;concept_b],[concept_b;concept_a],[fdr;fdr],Nc,Nc);
